...
LOG_DIR=/opt/log/100003171
## Adjust server port if necessary
SERVER_PORT=8888

## Adjust memory settings if necessary
export JAVA_OPTS="-server -Xms128m -Xmx128m -Xss256k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=384m -XX:NewSize=128m -XX:MaxNewSize=128m -XX:SurvivorRatio=18"
